...
public class CanCoderFactoryBuilder {
    ...
    public AbsoluteEncoderFactory<CanCoderAbsoluteConfiguration> build() {
        return configuration -> {
            ...
            config.initializationStrategy = SensorInitializationStrategy.BootToAbsolutePosition; //new addition to solve reset problem, may cause errors who knows not me 
